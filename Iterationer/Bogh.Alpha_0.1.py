...
with col1:
        ...
        max_x_value = st.slider("x-values", value = [int(min(df[x_axis])), int(max(df[x_axis])+1)], min_value = int(min(df[x_axis])), max_value = int(max(df[x_axis])+1))
        max_y_value = st.slider("y-values", value = [int(min(df[y_axis])), int(max(df[y_axis])+1)], min_value = int(min(df[y_axis])), max_value = int(max(df[y_axis])+1))
