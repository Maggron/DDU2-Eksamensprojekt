...
with st.sidebar:
    st.title('SIDEBAR!!!')
    st.text("0. kvartil: " + str(np.nanquantile(y_values,0/4)))
    st.text("1. kvartil: " + str(np.nanquantile(y_values,1/4)))
    st.text("2. kvartil: " + str(np.nanquantile(y_values,2/4)))
    st.text("3. kvartil: " + str(np.nanquantile(y_values,3/4)))
    st.text("4. kvartil: " + str(np.nanquantile(y_values,4/4)))
    st.text("Mean: " + "{:.2f}".format(np.nanmean(y_values)))
    st.text("Variance: " + "{:.2f}".format((np.nanquantile(y_values,4/4)) - (np.nanquantile(y_values,0/4))))