...
if uploaded_file is not None:
    ...
    with col1:
        ...
        max_y_value = st.slider("max y-value", 0, len(df), len(df), 2000)
...
print(len(x_values),"x")
print(len(y_values),"y")
...
if st.button('Generate Plot'):
    ...
    if plot_type == 'Line Plot':
        ...
        plt.scatter(x_values,y_values,2)
        #sns.scatterplot(x=x_values, y=y_values, ax=ax,legend=False,color="0.2")
