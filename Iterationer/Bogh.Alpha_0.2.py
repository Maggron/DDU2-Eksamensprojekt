...
if col3.button('Generate Plot'):
    ...
    if plot_type == 'Line Plot':
        ...
        sns.barplot(x=x_values, y=y_values, ax=ax, color='blue', linewidth=0, edgecolor=None)
        ...
        sns.countplot(x=x_values, ax=ax, edgecolor=None, linewidth=0)
        y_axis = 'Count'
...
with st.sidebar:
    ...
    elif plot_type in ['Distribution Plot', 'Count Plot']:
        st.text("Please select a viable plot to display statistics")
